...
smallCircle = new google.maps.Circle({
  ...
  map: map
      ...
      var newPosition = google.maps.geometry.spherical.computeOffset(smallCircle.getCenter(), 5, google.maps.geometry.spherical.computeHeading(smallCircle.getCenter(), marker.getPosition()));
