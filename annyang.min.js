...
google.maps.event.addListener(smallerCircle, 'radius_changed', function() {
  ...
  if (distance < smallerCircle.alertRadius) {
    ...
    // If the user is inside the alert radius, reset position of smallerCircle and speed up ghost by 2

    // Update the position of the small circle
    smallerCircle.setCenter(new google.maps.LatLng(39.0135, -94.5495));
